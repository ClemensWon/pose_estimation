...
# Parameters
input_file = "pose_estimation/dataset/dataset.json"
train_output_file = "pose_estimation/dataset/train_dataset.json"
test_output_file = "pose_estimation/dataset/test_dataset.json"
split_ratio = 0.9
